...
public class PostJSONObjectRequest implements Request {
    ...
    public static PostJSONObjectRequest post(VolleyCallback<JSONObject> callback, String raterUserId, String rateeUserId, float rating){
        HashMap<String, String> params = new HashMap<String, String>();

        params.put("raterId", raterUserId);
        params.put("rateeId", rateeUserId);
    ...
    public static PostJSONObjectRequest addFav(VolleyCallback<JSONObject> callback, String postId){
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("user_id", Connection.get().getUserId());
